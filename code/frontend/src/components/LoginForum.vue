    ...
    <v-app>
        <v-container fill-height="fill-height">
            ...
            <v-flex class="login-form text-xs-center"> 
                ...
                <v-icon class="mr-2" large="large">work</v-icon> Smart Shopping Login
                </div>
                <v-card light="light">
                <v-card-text>
                    ...
                    <v-btn v-if="options.isLoggingIn" @click.prevent="" block="block" type="submit">Sign in</v-btn>
                    <v-btn v-else block="block" type="submit" @click.prevent="(options.isLoggingIn = true)">Sign up</v-btn>
                    </v-form>
                </v-card-text>
                </v-card>
